...
local workspace_folder = vim.fn.expand("~/.local/share/eclipse/") .. vim.fn.fnamemodify(root_dir, ":p:h:t")
...
local config = {
  ...
  cmd = {
    ...
    '-jar', home .. "/plugins/org.eclipse.equinox.launcher_1.6.700.v20231214-2017.jar",
